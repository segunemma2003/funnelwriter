...
<head>
    ...
    <title> @yield('title') | Funnel Writer</title>
</head>
<body>
    <!-- Header Section -->
    <header>
    ...
    <section class="main__section">
        ...
        <nav class="sidebar">
            <div class="toggle__sidebar">
                <img src="{{asset('publics/images/close-dash.svg')}}" alt="toggle__sidebar">
            </div>
