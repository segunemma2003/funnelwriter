                    ...
                    <div class="project">
                        ...
                        <div class="none options">
                            <ul>
                                ...
                                <li class="red"><a href="{{ route('script.delete') }}">Delete</a></li>
                            </ul>
                        </div>
                        <div class="top">
                            <img src="images/folder_orange.svg" alt="folder-orange">
                            <p class="items__created orange">0 items created</p>
                        </div>
                        <a href="{{route('affiliateboxlaunch')}}" class="project__title text-blue">{{ $script->project->name }}</a>
                        <p class="project__description text-light-blue">{{ $script->project->desc }}</p>
                    </div>
                    @endforeach
                    @endif
