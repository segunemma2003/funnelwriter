                ...
                <div class="right-main-content">
                    ...
                    <div class="right-content">
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num1.svg')}}" alt="">The Fearmonger Headline</legend>
                            <div class="output">
                                <form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num2.svg')}}" alt="">The Rally Cry Headline (Positive)</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num3.svg')}}" alt="">The Rally Cry Headline (Negative)</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num4.svg')}}" alt="">The Question Headline 1</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num5.svg')}}" alt="">The Question Headline 2</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num6.svg')}}" alt="">The Fortune Teller Headline</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num7.svg')}}" alt="">The Imagination Headline</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num8.svg')}}" alt="">The Reminder Headline</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num9.svg')}}" alt="">The Urgency Headline 2</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num10.svg')}}" alt="">The Audience Headline</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
                        ...
                        <fieldset class="writer">
                            <legend> <img src="{{asset('images/num11.svg')}}" alt="">The Command Headline</legend>
                            <div class="output">
                                <form>
                                    <input class="show-output" placeholder="Write attention grabbing headlines"></input>
                                </form>
