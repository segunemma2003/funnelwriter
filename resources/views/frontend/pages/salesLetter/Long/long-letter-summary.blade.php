...
<main class="main__content">
          ...
          <div class="summary" id="long">
            <p class="text-center">Imagine Never <span class="q1">[1]</span>Again</p>
            <br>
            <h2 class="q2 text-center text-red">How to [5] this week Without [6]</h2>
            <br>
            <h4 class="text-center"><span class="q2">[2]</span> is a <span class="q3">[3]</span> for <span class="q4">[4]</span> That Want <span class="q5">[5]</span> Without <span class="q6">[6]</span></h4>
                <br>
                <br>
              <h3 class="text-center">INSERT PRODUCT MOCKUP HERE</h3>
              <br>
              <h3 class="text-center">INSERT OFFER STACK</h3>
              <br>
              <br>
            <h3 class="text-center text-purple">I understand that your time is valuable and so I’ll get straight to the point, there are <em>3 problems</em> right now.</h3>
            <br>
            <p>Problem #1. You Struggle to <span class="q7">[7]</span> because <span class="q8">[8]</span>. You think <span class="q9">[9]</span> and become discouraged when other people with way less <span class="q10"></span> seem to <span class="q5">[5]</span>
            </p>
            <br>
            <p>Problem #2: I know you may have tried <span class="q11"></span> but they turn out to <span class="q12"></span>.</p>
            <br>
            <p>Problem #3: Attempting to help you solve this problem are a large influx of <span class="q13"></span> who promise to <span class="q5"></span> but end up never delivering on that promise. Right now you are so frustrated you almost don’t believe this problem can really ever be solved.</p>
            <br>
            <br>
            <h3 class="text-center text-purple">Now if these problems sound a little close to home, you're probably in one of these 2 camps...</h3>
            <br>
            <p>You really wish <span class="q5"></span> but no matter what you do <span class="q14"></span></p>
            <br>
            <br>
            <br>

            <h4 class="text-purple text-center">I am going to Help You put an end to all of this, right here and now - without wasting any more time.</h4>
            <br>
            <p>Imagine dramatically reducing <span class="q17"></span></p>
            <br>
            <p>Imagine jump starting <span class="q18"></span></p>
            <p>Imagine never having to <span class="q19"></span> again</p>

            <p class="text-center">Yes!</p>
            <p class="text-center">You can <span class="q5"></span> Without <span class="q6"></span></p>
            <br>
            <h3 class="text-center text-purple">Introducing <span class="q2"></span></h3>

            <h4 class="text-center">[Product MockUp]</h4>
            <br>
            <h4 class="text-center">[Product Tagline From OfferSheet]</h4>
            <br>
            <p>Exactly what you need to <span class="q20"></span></p>

            <p><span class="q5"></span> is Simply About <span class="q21"></span></p>
            <p>The Moment You Get <span class="q21"></span> Right, Everything Changes!</p>

            <br>
            <br>
            <p>My name is <span class="q22"></span> and I help <span class="q23"></span> Move from <span class="q19"></span> to <span class="q5"></span>, in that past <span class="q24"></span> years I have helped <span class="q25"></span> <span class="q23"></span> achieve their <span class="q26"></span> Goals.   </p>

            <br>
            <br>
            <p>I have been featured on <span class="q27"></span>. </p>
            <br>
            <br>
            <p>Just like you I have also <span class="q28"></span> until I was able to finally <span class="q20"></span></p>
            <br>
            <br>
            <p>And one thing I have realized in all of these years is that all it takes to <span class="q29"></span> is to Figure out <span class="q21"></span> </p>
            <br>
            <p>I mean <span class="q11"></span> Is simply NOT enough! This is because <span class="q12"></span> </p>
            <br>
            <br>
            <p class="text-center">What you need is <span class="q21"></span>. Period!  </p>
            <br>
            <h3 class="text-center">Grab The <span class="q2"></span>....Fast</h3>
            <br>

            <h4 class="text-center">[Insert Offer Stack]</h4>
            <br>
            <p class="text-center">Yes, I Want <span class="q2"></span></p>
            <br>
            <br>
            <h3 class="text-purple text-center">Here is What You Get Inside</h3>
            <br>
            <p>If you want to <span class="q20"></span>, <span class="q2"></span> is still the best way to do it Without <span class="q1"></span>. You get:</p>
            <br>
            <span class="q30"></span>

            <br>
            <h3 class="text-center text-purple">And if you’re Not 100% Satisfied… Neither Am I.​</h3>
            <br>
            <br>
            <p>
            ...
            <br>
            <p>But I’m super proud of the products I create and I know anyone who buys them and implements the strategy will be thrilled with their purchase.</p>
                <br>
            <p>That’s why I’m offering a 30-day money-back guarantee. I can guarantee your satisfaction with the quality of everything you get inside <span class="q2"></span> plus the immense time and stress it will save you.</p>
                <br>
            <p>Of course, if you’re not happy with <span class="q2"></span>, I will refund your money within 30 days of your purchase.</p>
                <br>
            <p>Now, I don’t know how long we will be able to offer this,...but we do know that the number of people that I’ll be able to help will be limited. we also know it won’t take long to fill up these available spots.</p>
                <br>
            <p>Now for the bad news: If you would like your own personal copy of <span class="q2"></span>... you may just be out of luck. </p>
                <br>
            <p>You see, at this point in time, it’s my intention to only offer a tiny, limited supply of the <span class="q2"></span> for “public consumption”. At the moment, I’ve only got 200 slots open, and once they’ve been snapped up – like I’m certain they will be very soon after this message goes “live” – that’s it. The “curtain falls” and you’ll probably never get another bit at the cherry! </p>
                <br>
            ...
            <h3 class="text-center">[Order Button]</h3>
          ...
          <div class="bottom-btns">
            <a class="btn-light-blue" href="long-letter.html">Go Back</a>
          </div>
        </main>
    </section>
            ...
            <ul class="export-options">
              <li class="export-option export-docx">
                <div>
                  ...
                  <p onClick="DownloadDoc()">Download as docx</p>
                </div>
              </li>
              ...
              <li class="export-option export-email">
                <div>
                  ...
                  <p onClick="SendMail()">Send to email</p>
                </div>
              </li>
            </ul>
            <div>
...
async function DownloadDoc(){
    let data=sessionStorage.getItem(document.querySelector(".summary").id)

    let response= await axios.post("{{route('letterDOC')}}",{data}).then((res)=>{
...
async function DownloadPDF(){
    ...
    let response= await axios.post("{{route('letterPDF')}}",{data}).then((res)=>{
    console.log(res.data.data)
    window.open("/"+res.data.data)
  }).catch((err)=>{
    console.log(err)
