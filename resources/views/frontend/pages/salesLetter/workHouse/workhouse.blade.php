                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <li class="question" id="q3">
                      <label class="label" >What is the type product?</label>
                      <div class="example">
                    ...
                    <li class="question" id="q25">
                      <label class="label">What is the prospect big struggle?</label>
                    ...
                    <li class="question" id="q26">
                      ...
                      <div class="example">(Ex: Write highly converting copies thatpull in sales without having to higher expensive copywriter)</div>
                      <input type="text">
                    </li>
                    ...
                    <li class="question" id="q20">
                      <label class="label">What does your readers really want tot achieve(Main goal)</label>
              ...
              <div id="prospects">
                <ul>
                  ...
                  <li class="question" id="q8">
                    ...
                    <div class="example">(Ex: get daily into product sales from your funnel)</div>
                    <input type="text">
                    <div class="add">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                  ...
                  <li class="question" id="q9">
                    <label class="label" >What is feature 1 value</label>
                  ...
                  <li class="question" id="q11">
                    <label class="label" >Testimonials sources</label>
              ...
              <div id="features">
                <ul>
                  ...
                  <li class="question" id="q30">
                    <label class="label" >What is the Bonus Value</label>
                    <div class="example"></div>
                    <input type="text">
                    <div class="add">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="question" id="q32">
                    ...
                    <div class="example">(Ex: this product took me a lot of time, trials and error and expereince to prepare)</div>
                    <input type="text">
                  </li>
                  <li class="question" id="q32">
                  ...
                  <li class="question" id="q32">
                    <label class="label" >What is the total value of your product without bonus?</label>
                ...
                <div class="btns">
                  <a href="{{route('long-letter-summary')}}" class="btn-blue">Next</a>
