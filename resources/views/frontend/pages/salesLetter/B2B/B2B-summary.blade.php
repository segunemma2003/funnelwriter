...
<main class="main__content">
          ...
          <div class="summary" id="B2B">
            ...
            <br>
            <br>
            <h3 class="text-purple text-center">But There is Good News!</h3>
            <br>
            ...
            <p>·  You've <span class="q9">[fw9]</span> which just resulted in <span class="q10">[fw10]</span>.</p>
            <p>· You've <span class="q11">[fw11]</span> which led to <span class="q12">[fw12]</span>.</p>
            <p>· You've <span class="q13">[fw13]</span> which just ended up in <span class="q14">[fw14]</span>.</p>
            <br>
            <br>
            <h3 class="text-center text-purple">Just Before I Was Ready to Close Up Shop, A Stroke of Luck Changed Everything.</h3>
            <p>You can only run into so many walls before you get so frustrated that the only option left seems to be quitting.</p>
            <p>I was just about at that point when I <span class="q22">[fw22]</span>.</p>
            <p>As soon as I discovered this, everything instantly got easier.</p>
            <h4>With this amount of success, I knew I couldn't keep it on lockdown.</h4>
            <p>Since then, I've run into multiple others who encountered the same, never-ending battle I went through. And it seemed pretty unfair to keep it to myself... especially since it's been such a huge stepping stone in my success.</p>
