                ...
                <ul>
                  ...
                  <ul>
                    <li class="question" id="q2">
                      <label class="label">What is your company city?</label>
                      <div class="example">(Ex: new York city)</div>
                      <input type="text">
                    </li>
              ...
              <div id="prospects">
                <ul>
                  ...
                  <li class="question" id="q8">
                    <label class="label" >What was the obstacle you faces before becoming a badass</label>
              ...
              <div id="features">
                <ul>
                  <li class="question" id="q27">
                    ...
                    <p class="label">Testimonial #1</p>
                    <div class="example"></div>
                    <input type="text">
                    <p class="label">Testimonial #1 Source</p>
                    <input type="text">
                    <div class="add">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                  ...
                  <li class="question" id="q30">
                    ...
                    <p class="label">Other solution #1</p>
                    <div class="example">(hiring a professional copywriter)</div>
                    <input type="text">
                    <p class="label">Other solution #1 PRICE</p>
                    <div class="example">(Ex: $300)</div>
                    <input type="text">
                    <div class="add">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                  ...
                  <li class="question" id="q31">
                    ...
                    <p class="label">Bonus #1</p>
                    <div class="example"></div>
                    <input type="text">
                    <p class="label">Bonus #1 value</p>
                    <input type="text">
                    <p class="label">Why Bonus #1 makes the main product better</p>
                    <input type="text">
                    <div class="add">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                ...
                <div class="btns">
                  <a href="#" class="btn-blue">Finish</a>
