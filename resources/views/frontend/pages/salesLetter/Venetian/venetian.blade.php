              ...
              <div id="product">
                <ul>
                  ...
                  <li class="question" id="q7">
                    <label class="label">What is your desire end result (be specific) of ypur product?</label>
                    <div class="example">(Ex: Write highly convertin copies that pull in sales without having to higher expensive copywriter)</div>
                    <input type="text">
                  </li>
              ...
              <div id="prospects">
                <ul>
                  <li class="question" id="q1">
                    ...
                    <div class="example">(converting boring ads copies, email sequence)</div>
                    <input type="text">
                    <div class="add">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                  ...
                  <li class="question" id="q9">
                    <label class="label">What time frame does the bonus section ends?</label>
                    <div class="example">(Ex: hh:mm:ss)</div>
                    <input type="text">
                  </li>
                  <li class="question" id="q9">
                    <label class="label">What is your guarantee?</label>
                    <div class="example">(Ex: 30days)</div>
                    <input type="text">
                  </li>
                  <li class="question" id="q9">
                    <label class="label">What is the Title of your Call To Action</label>
                    <div class="example">(Ex: Buy Now, Rush Your Copy Now etc)</div>
                    <input type="text">
                  </li>
                </ul>
                <div class="btns">
