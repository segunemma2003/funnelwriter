                ...
                <ul>
                  <li class="question" id="q22">
                    ...
                    <li class="question" id="q21">
                        ...
                        <div class="example">(Ex: write highly converting sales copies that pull in crazy system)</div>
                        <input type="text">
                      </li>
                      <li class="question" id="q21">
              ...
              <div id="prospects">
                <ul>
                    <li class="question" id="q21">
                        ...
                        <div class="example">(Ex: convert boring ads copies, email sequence into sales machine)</div>
                        <input type="text">
                        <div class="add">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="23" height="23" rx="4.5" stroke="#4834D4"/>
                  ...
                  <li class="question" id="q10">
                    <label class="label" >What are the Other Solutions your prospect depends on aside using your product?</label>
