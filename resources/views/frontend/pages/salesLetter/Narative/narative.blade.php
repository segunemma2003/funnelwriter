            ...
            <form class="questions" id="short">
              <div id="product">
                <ul>
                  ...
                  <li class="question" id="q7">
                    <label class="label">What is the name of your product?</label>
                    <div class="example">Write highly converting copies that pull in sales without having to higher expensive copywriter</div>
                    <input type="text">
                  </li>
                  ...
                  <li class="question" id="q13">
                    <label class="label">What is the scarity of this product?</label>
              ...
              <div id="prospects">
                <ul>
                  ...
                  <li class="question" id="q13">
                    <label class="label">What tie frame does the bonus section ends?</label>
